...
/*
   相机2预览场景
*/
public class ThirdCameraPreview extends Fragment{
	private String TAG= ThirdCameraPreview.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		View mView = inflater.inflate(R.layout.thirdcamerapreview,container,false);
		SurfaceView surfaceView = mView.findViewById(R.id.thirdsurfaceview);
