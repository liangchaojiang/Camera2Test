...
/*
   相机3预览场景
*/
public class FourthCameraPreview extends Fragment{
	private String TAG= FourthCameraPreview.class.getSimpleName();
	private MainActivity mMainActivity;


	private SurfaceHolder surfaceHolder;

	private String cameraId="3";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		View mView = inflater.inflate(R.layout.fourthcamerapreview,container,false);
		SurfaceView surfaceView = mView.findViewById(R.id.fourthsurfaceview);
