...
/*
   相机0预览场景
*/
public class FirstCameraPreview extends Fragment{
	private String TAG= FirstCameraPreview.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		View mView = inflater.inflate(R.layout.firstcamerapreview,container,false);

		SurfaceView surfaceView = mView.findViewById(R.id.firstsurfaceview);
